 ...
 * 转让管理员权限
 */
export async function transferAdmin(req, res) {
    const { id } = req.params;
    const currentUserId = req.userId;
    // 检查当前用户是否是管理员
    const currentUser = await prisma.user.findUnique({
 ...
 * 获取部门成员列表（部门管理员）
 */
export async function getDepartmentMembers(req, res) {
    const currentUserId = req.userId;
    // 获取当前用户管理的部门
 ...
 * 转让部门管理员权限
 */
export async function transferDepartmentAdmin(req, res) {
    const { id } = req.params;
    const currentUserId = req.userId;
    // 获取当前用户管理的部门
    const department = await prisma.department.findUnique({
 ...
 * 部门管理员移除部门成员
 */
export async function removeDepartmentMember(req, res) {
    const { id } = req.params;
    const currentUserId = req.userId;
    // 获取当前用户管理的部门
    const department = await prisma.department.findUnique({
 ...
 * 部门管理员禁用/启用本部门成员
 */
export async function toggleDepartmentMemberStatus(req, res) {
    const { id } = req.params;
    const currentUserId = req.userId;
    // 获取当前用户管理的部门
    const department = await prisma.department.findUnique({
